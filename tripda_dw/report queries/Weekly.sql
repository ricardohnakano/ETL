SELECT
	...
	EXTRACT(week FROM tprinc.report_date) AS Week_Number,
	(CASE WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 40 THEN '30.Dec - 05.Jan'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 41 THEN '06.Oct - 12.Oct'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 42 THEN '13.Oct - 19.Oct'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 43 THEN '20.Oct - 26.Oct'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 44 THEN '27.Oct - 02.Nov'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 45 THEN '03.Nov - 09.Nov'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 46 THEN '10.Nov - 16.Nov'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 47 THEN '17.Nov - 23.Nov'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 48 THEN '24.Nov - 30.Nov'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 49 THEN '01.Dec - 07.Dec'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 50 THEN '08.Dec - 14.Dec'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 51 THEN '15.Dec - 21.Dec'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 52 THEN '22.Dec - 28.Dec'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2014 AND EXTRACT(week FROM tprinc.report_date) = 53 THEN '29.Dec - 04.Jan'

			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 1 THEN '29.Dec - 04.Jan'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 2 THEN '05.Jan - 11.Jan'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 3 THEN '12.Jan - 18.Jan'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 4 THEN '19.Jan - 25.Jan'		
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 5 THEN '26.Jan - 01.Feb'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 6 THEN '02.Feb - 08.Feb'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 7 THEN '09.Feb - 15.Feb'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 8 THEN '16.Feb - 22.Feb'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 9 THEN '23.Feb - 01.Mar'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 10 THEN '02.Mar - 08.Mar'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 11 THEN '09.Mar - 15.Mar'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 12 THEN '16.Mar - 22.Mar'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 13 THEN '23.Mar - 29.Mar'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 14 THEN '30.Mar - 05.Apr'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 15 THEN '06.Apr - 12.Apr'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 16 THEN '13.Apr - 19.Apr'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 17 THEN '20.Apr - 26.Apr'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 18 THEN '27.Apr - 03.May'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 19 THEN '04.May - 10.May'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 20 THEN '11.May - 17.May'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 21 THEN '18.May - 24.May'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 22 THEN '25.May - 31.May'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 23 THEN '01.Jun - 07.Jun'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 24 THEN '08.Jun - 14.Jun'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 25 THEN '15.Jun - 21.Jun'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 26 THEN '22.Jun - 28.Jun'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 27 THEN '29.Jun - 05.Jul'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 28 THEN '06.Jul - 12.Jul'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 29 THEN '13.Jul - 19.Jul'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 30 THEN '20.Jul - 26.Jul'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 31 THEN '27.Jul - 02.Aug'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 32 THEN '03.Aug - 09.Aug'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 33 THEN '10.Aug - 16.Aug'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 34 THEN '17.Aug - 23.Aug'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 35 THEN '24.Aug - 30.Aug'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 36 THEN '31.Aug - 06.Sep'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 37 THEN '07.Sep - 13.Sep'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 38 THEN '14.Sep - 20.Sep'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 39 THEN '21.Sep - 27.Sep'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 40 THEN '28.Sep - 04.Oct'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 41 THEN '05.Oct - 11.Oct'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 42 THEN '12.Oct - 18.Oct'
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 43 THEN '19.Oct - 25.Oct'			
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 44 THEN '26.Oct - 01.Nov'
			...
			WHEN EXTRACT (YEAR FROM tprinc.report_date) = 2015 AND EXTRACT(week FROM tprinc.report_date) = 53 THEN '28.Dec - 03.Jan' END) AS report_week,
...
FULL JOIN
	...
	FROM
		users u
	WHERE
		u.guid NOT IN ('5788b25a-fbb6-4ee3-b2e0-c6d239dada08','93a33b54-fd34-4575-ad72-3028b7e368b3','30932f00-9862-4039-aea3-20d052e7dc53','73535830-4412-4304-bc76-091361452f2b','30932f00-9862-4039-aea3-20d052e7dc53' ,'73535830-4412-4304-bc76-091361452f2b' ,'2737e141-525c-40ad-9031-d632e9fe6d07' ,'f22d4ee9-5960-4019-ac20-d0ce52ccaeff' ,'5669b34c-67d3-4470-b93a-a00756a973b8' ,'ae338e24-be9e-4c67-86be-e90c3fbfc57c' ,'8fcc9eb1-602f-4464-be56-8ad1028c2c04' ,'177ccacd-a363-40e5-a23c-e2bcc550d224' ,'34cb2d85-81b5-4fc6-a596-1adcd8f47a2a' ,'5cb8ad99-c476-4ba0-a2b0-a6560b7372b2' ,'6591fa5a-8fd2-4ae8-832d-c520fbe9862d' ,'e81a32a3-e2cb-4b3f-9f04-cc4db1ad678a' ,'e0acbd91-9229-4411-8020-0ae56d6d9552' ,'2d933580-ed88-4a81-ab4f-5cd12a997ff7' ,'47c5ab88-4aea-4ce7-8c2e-291db3ca17bb' ,'f877ab95-d146-430d-a7d3-4ee188bc089e' ,'f5d631b2-cdb0-4a6f-befb-d8001d2ad383' ,'e27888a4-d054-47c2-a359-210d2b4cff8d' ,'1e9cc6bb-cd3f-4d09-8b17-daa982a317ea' ,'78ba300f-26dc-408c-8de7-15ac499512de' ,'b58bbeaf-0f74-40b8-ae9e-9697d04f0841' ,'bea52e68-f4c3-4d46-a527-d68c59784426') AND u.is_active = '1' GROUP BY
		date(u.created_at),
...
WHERE 
	EXTRACT(YEAR FROM tprinc.report_date) = '2015' 
	AND (EXTRACT(week FROM tprinc.report_date) = (EXTRACT(week FROM date(now()))-1) 
    OR EXTRACT(week FROM tprinc.report_date) = (EXTRACT(week FROM date(now())) -2) 
    OR EXTRACT(week FROM tprinc.report_date) = (EXTRACT(week FROM date(now())) -3) 
    OR EXTRACT(week FROM tprinc.report_date) = (EXTRACT(week FROM date(now())) -4) )   
GROUP BY
	Report_Year,
	Week_Number,
	report_week,
