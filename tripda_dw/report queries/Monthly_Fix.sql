SELECT 
    ...
    EXTRACT(MONTH FROM tprinc.report_date) AS reference_number, 
    (CASE WHEN EXTRACT(MONTH FROM tprinc.report_date) = 1 THEN 'January' 
            ...
            WHEN EXTRACT(MONTH FROM tprinc.report_date) = 12 THEN 'December' END) AS report_reference, 
...
WHERE 
    (CASE WHEN (EXTRACT(YEAR FROM now())) = '2016'  AND (EXTRACT(MONTH FROM now())) = '1' THEN
            (EXTRACT(YEAR FROM tprinc.report_date) = '2015'  AND EXTRACT(MONTH FROM tprinc.report_date) = '9') OR 
            (EXTRACT(YEAR FROM tprinc.report_date) = '2015'  AND EXTRACT(MONTH FROM tprinc.report_date) = '10') OR
            (EXTRACT(YEAR FROM tprinc.report_date) = '2015'  AND EXTRACT(MONTH FROM tprinc.report_date) = '11') OR
            (EXTRACT(YEAR FROM tprinc.report_date) = '2015'  AND EXTRACT(MONTH FROM tprinc.report_date) = '12') 
        WHEN (EXTRACT(YEAR FROM now())) = '2016'  AND (EXTRACT(MONTH FROM now())) = '2' THEN
            (EXTRACT(YEAR FROM tprinc.report_date) = '2015'  AND EXTRACT(MONTH FROM tprinc.report_date) = '10') OR 
            (EXTRACT(YEAR FROM tprinc.report_date) = '2015'  AND EXTRACT(MONTH FROM tprinc.report_date) = '11') OR 
            (EXTRACT(YEAR FROM tprinc.report_date) = '2015'  AND EXTRACT(MONTH FROM tprinc.report_date) = '12') OR 
            (EXTRACT(YEAR FROM tprinc.report_date) = '2016'  AND EXTRACT(MONTH FROM tprinc.report_date) = '1')
        WHEN (EXTRACT(YEAR FROM now())) = '2016'  AND (EXTRACT(MONTH FROM now())) = '3' THEN
            (EXTRACT(YEAR FROM tprinc.report_date) = '2015'  AND EXTRACT(MONTH FROM tprinc.report_date) = '11') OR 
            (EXTRACT(YEAR FROM tprinc.report_date) = '2015'  AND EXTRACT(MONTH FROM tprinc.report_date) = '12') OR
            (EXTRACT(YEAR FROM tprinc.report_date) = '2016'  AND EXTRACT(MONTH FROM tprinc.report_date) = '1') OR
            (EXTRACT(YEAR FROM tprinc.report_date) = '2016'  AND EXTRACT(MONTH FROM tprinc.report_date) = '2')
        WHEN (EXTRACT(YEAR FROM now())) = '2016'  AND (EXTRACT(MONTH FROM now())) = '4' THEN
            (EXTRACT(YEAR FROM tprinc.report_date) = '2015'  AND EXTRACT(MONTH FROM tprinc.report_date) = '12') OR 
            (EXTRACT(YEAR FROM tprinc.report_date) = '2016'  AND EXTRACT(MONTH FROM tprinc.report_date) = '1') OR
            (EXTRACT(YEAR FROM tprinc.report_date) = '2016'  AND EXTRACT(MONTH FROM tprinc.report_date) = '2') OR
            (EXTRACT(YEAR FROM tprinc.report_date) = '2016'  AND EXTRACT(MONTH FROM tprinc.report_date) = '3')
        ELSE
            ...
            EXTRACT(MONTH FROM tprinc.report_date) = (EXTRACT(MONTH FROM date(now())) -4)) END)
GROUP BY
    report_year, 
    reference_number, 
    report_reference, 
